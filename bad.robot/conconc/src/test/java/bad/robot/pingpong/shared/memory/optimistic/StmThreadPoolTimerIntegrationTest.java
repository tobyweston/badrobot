...
public class StmThreadPoolTimerIntegrationTest {

    private static ThreadLocalMovableClock clock = new ThreadLocalMovableClock();
    private static final StmThreadPoolTimer timer = new StmThreadPoolTimer(new ThreadLocalStopWatch(clock));
